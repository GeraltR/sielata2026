  ...
  return (
    <footer className="bg-ink text-ink-inverse/60">
      <div className="max-w-7xl mx-auto px-6 pt-16 pb-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          <div className="md:col-span-1">
            ...
            <p className="text-sm leading-relaxed mb-6">
              ...
              Organizatorzy Festiwalu Modelarskiego — corocznego święta
              lotnictwa i modelarstwa na Śląsku.
            </p>
            <div className="flex gap-2">
              {[
                {
                  href: "https://www.facebook.com/Sielata-561882014014619/",
                  label: "f",
                },
                {
                ...
                {
                  href: "https://www.linkedin.com/in/pawe%C5%82-m%C4%99telski-a89b34aa/",
                  label: "in",
                },
              ].map((s) => (
                <a
        ...
        {/* Copyright */}
        <div
          className="pt-6 border-t border-white/10 flex flex-col md:flex-row
                        justify-between items-center gap-2 text-xs"
        >
          <span>
            © {year} <span className="text-accent">SieLata</span> · Jaworzno.
            Wszelkie prawa zastrzeżone.
          </span>
          <span>
            {festival.edition} Festiwal Modelarski Jaworzno ·{" "}
